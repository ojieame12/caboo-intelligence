...
/*
 * Documentation:
 * Radio Group — https://app.subframe.com/509baa5d9423/library?component=Radio+Group_c4b6300e-20b4-4f3e-8b9f-379a046674ca
 */
  ...
  function RadioGroupRoot(
    ...
    return (
      <SubframeCore.RadioGroup.Root asChild={true} {...otherProps}>
        ...
        >
          {label ? (
            <span className="text-token font-token text-default-font">
              {label}
            </span>
          ) : null}
          {children ? (
