...
/*
 * Documentation:
 * Vertical Stepper — https://app.subframe.com/509baa5d9423/library?component=Vertical+Stepper_bdc0291d-b5be-40c5-ae2f-527a868488b2
 */
      ...
      >
        ...
        >
          {stepNumber ? (
            <span
              className={SubframeUtils.twClassNames(
                "text-token font-token text-subtext-color text-center",
                {
                  "text-token font-token text-brand-700": variant === "active",
        ...
        {label ? (
          <span
            className={SubframeUtils.twClassNames(
              ...
              {
                "text-token font-token text-default-font": variant === "active",
