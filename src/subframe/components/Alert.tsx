...
/*
 * Documentation:
 * Alert — https://app.subframe.com/509baa5d9423/library?component=Alert_3a65613d-d546-467c-80f4-aaba6a7edcd5
 */
        ...
        <div className="flex w-full items-center gap-4">
          ...
          <div className="flex grow shrink-0 basis-0 flex-col items-start">
            {title ? (
              <span
                className={SubframeUtils.twClassNames(
                  "w-full whitespace-pre-wrap text-token font-token text-default-font",
                  {
