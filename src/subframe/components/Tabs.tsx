...
/*
 * Documentation:
 * Tabs — https://app.subframe.com/509baa5d9423/library?component=Tabs_e1ad5091-8ad8-4319-b1f7-3e47f0256c20
 */
  ...
  return (
    ...
    >
      ...
      {children ? (
        <span
          className={SubframeUtils.twClassNames(
            "text-token font-token text-subtext-color group-hover/d5612535:text-default-font",
            {
              "text-neutral-400 group-hover/d5612535:text-neutral-400":
                disabled,
              "text-brand-700 group-hover/d5612535:text-brand-700": active,
