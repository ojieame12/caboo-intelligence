...
/*
 * Documentation:
 * Checkbox Group — https://app.subframe.com/509baa5d9423/library?component=Checkbox+Group_f9f1b596-c6b3-4d60-aa9a-f34b353f8aa5
 */
  ...
  return (
    ...
    >
      {label ? (
        <span
          className={SubframeUtils.twClassNames(
            "text-token font-token text-default-font",
