module.exports = {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        caption: "pxGroteskFont",
        "caption-bold": "pxGroteskFont",
        body: "pxGroteskFont",
        token: "pxGroteskFont",
        "heading-3": '"Season Mix TRIAL"',
        "heading-2": '"Season Mix TRIAL"',
        "heading-1": '"Season Mix TRIAL"',
        "monospace-body": "pxGroteskFont",
      },
      boxShadow: {
